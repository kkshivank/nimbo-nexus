...
//     e.preventDefault()
//     setLoading(true)
//     // Simulate submission (replace with your API later)
...
//           <p className="mt-3 text-muted-foreground max-w-2xl">Let’s discuss your project and how we can help.</p>
//         </div>
//       </section>
...
//           <div>
//             <form onSubmit={onSubmit} className="space-y-4 rounded-lg border p-6 bg-card">
//               <div>
...
//                 <Textarea id="message" name="message" required placeholder="Tell us about your needs..." />
//               </div>
...
//                 <br />
//                 contact@read-itsoft.com • +1 (555) 123-4567
//               </p>
//             </div>
