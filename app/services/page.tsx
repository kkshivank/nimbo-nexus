  ...
  const sections = [
    {
      ...
      description:
        "Hands-on workshops and training sessions where we share real, practical skills across leading platforms — built for people who want to learn by doing.",
      cards: [
        {
          title: "Salesforce Training",
          description:
            "Practical, role-based learning paths covering Admin, Developer, and Architect tracks — built around real scenarios, not just theory.",
          imgUrl: "/trainsales.png",
          imgAlt: "Salesforce Training",
        },
        {
          title: "AWS Certification Prep",
          description:
            "Hands-on labs and study sessions focused on building cloud fundamentals and preparing for AWS certification exams.",
          imgUrl: "/trainaws.png",
          imgAlt: "AWS Training",
        },
        {
          title: "Microsoft Power Platform",
          description:
            "Guided sessions for citizen developers and IT professionals covering Power BI, Power Apps, and Power Automate.",
          imgUrl: "/trainmicro.png",
          imgAlt: "Microsoft Training",
        },
        {
          title: "Modern Web Development",
          description:
            "Real-world sessions covering React, Next.js, accessibility standards, and performance-first design principles.",
          imgUrl: "/trainweb.png",
          imgAlt: "React Training",
        },
      ],
      note: "Every session includes hands-on exercises and real project scenarios, with support to help concepts actually stick.",
    },
    {
      title: "Salesforce",
      description:
        "Exploring the Salesforce ecosystem through real implementations, hands-on development, and community-driven learning.",
      cards: [
        {
          title: "Sales & Service Cloud",
          description:
            "Learning and building sales and customer-service workflows with Sales and Service Cloud — with a focus on scalability, automation, and real-world usability.",
          imgUrl: "/salesforce-crm-implementation-stock.png",
          imgAlt: "Salesforce CRM Implementation",
        },
        {
          title: "Experience Cloud & Velocity",
          description:
            "Exploring personalized digital experiences using Experience Cloud and Salesforce Velocity for industry-specific workflows and customer journeys.",
          imgUrl: "/salesforce-marketing-cloud-contact-center-stock.png",
          imgAlt: "Salesforce Clouds",
        },
        {
          title: "LWC Development",
          description:
            "Building fast, reusable Lightning Web Components (LWC) as part of real Salesforce projects — learning modern frontend patterns along the way.",
          imgUrl: "/api-integration-diagram-stock.png",
          imgAlt: "Salesforce Development",
        },
        {
          title: "Integration, Marketing Cloud & Agentforce",
          description:
            "Connecting Salesforce with other systems through integrations, exploring Marketing Cloud engagement, and experimenting with Agentforce automation.",
          imgUrl: "/workflow-automation-stock.png",
          imgAlt: "Salesforce Automation",
        },
      ],
    },
    {
      title: "Microsoft Power Platform",
      description:
        "Learning low-code development by building real dashboards, apps, and automations on Microsoft Power Platform.",
      cards: [
        {
          title: "Power BI Analytics",
          description:
            "Turning raw data into interactive dashboards and insights through hands-on Power BI projects.",
          imgUrl: "/power-bi-dashboard-stock.png",
          imgAlt: "Power BI Dashboards",
        },
        {
          title: "Power Apps Development",
          description:
            "Building custom apps that solve real workflow problems, learning to connect data sources along the way.",
          imgUrl: "/microsoft-power-apps-ui-stock.png",
          imgAlt: "Power Apps Development",
        },
        {
          title: "Power Automate Solutions",
          description:
            "Designing automation flows that reduce manual work and integrate with Microsoft 365 and other apps.",
          imgUrl: "/power-automate-flows-stock.png",
          imgAlt: "Power Automate Flows",
        },
        {
          title: "Dataverse & Data Management",
          description:
            "Exploring how to unify and structure data using Dataverse as part of real Power Platform builds.",
          imgUrl: "/dataverse-data-model-stock.png",
          imgAlt: "Dataverse Architecture",
        },
      ],
    },
    {
      title: "AWS & Cloud",
      description:
        "Learning cloud fundamentals and best practices on AWS through hands-on projects — migration, cost, and security included.",
      cards: [
        {
          title: "Cloud Migration & Modernization",
          description:
            "Exploring how workloads move to AWS through practical migration exercises and modernization patterns.",
          imgUrl: "/aws-cloud-migration-datacenter-stock.png",
          imgAlt: "AWS Cloud Migration",
        },
        {
          title: "Cost Optimization & FinOps",
          description:
            "Learning to manage cloud costs through rightsizing, reserved instances, and smarter architectural choices.",
          imgUrl: "/cloud-cost-optimization-stock.png",
          imgAlt: "AWS Cost Optimization",
        },
        {
          title: "Security & Compliance",
          description:
            "Understanding cloud security fundamentals — identity management, encryption, audit trails, and compliance basics.",
          imgUrl: "/cloud-security-aws-stock.png",
          imgAlt: "AWS Security",
        },
      ],
    },
    {
      title: "DevOps",
      description:
        "Exploring how modern teams build, ship, and run software reliably — CI/CD, containers, and infrastructure as code, learned through real setups.",
      cards: [
        {
          title: "DevOps & Platform Engineering",
          description:
            "Learning to build reliable infrastructure — CI/CD pipelines, containerized setups (Kubernetes/Docker), and infrastructure as code (Terraform) across AWS & GCP.",
        ...
        },
        {
          title: "DevOps & CI/CD Pipelines",
          description:
            "Exploring automated pipelines, infrastructure as code, containerization, and monitoring through hands-on AWS projects.",
          imgUrl: "/devops-pipeline-aws-stock.png",
          imgAlt: "DevOps on AWS",
        },
      ],
    },
    {
      title: "React & Web Development",
      description:
        "Building modern web experiences together — dashboards, portals, and applications focused on performance and usability.",
      cards: [
        {
          title: "Custom Dashboards & Portals",
          description:
            "Building interactive, real-time dashboards and portals as hands-on projects, with a focus on clean data visualization.",
          imgUrl: "/react-dashboard-web-app-stock.png",
          imgAlt: "React Dashboards",
        },
        {
          title: "Enterprise Web Applications",
          description:
            "Developing web apps with Next.js, React, and TypeScript, learning what it takes to build fast and scalable products.",
          imgUrl: "/modern-web-app-coding-stock.png",
          imgAlt: "Modern Web Apps",
        },
        {
          title: "Design Systems & Component Libraries",
          description:
            "Exploring reusable design systems and component libraries that keep projects consistent and easier to build on.",
          imgUrl: "/design-system-components-stock.png",
          imgAlt: "Design Systems",
        },
        {
          title: "Performance & Accessibility",
          description:
            "Learning WCAG accessibility practices, Core Web Vitals optimization, and inclusive design through real projects.",
          imgUrl: "/react.png",
          imgAlt: "Web Performance",
        },
      ],
    },
    {
      title: "AI & Machine Learning",
      description:
        "Exploring artificial intelligence and machine learning through hands-on experimentation, projects, and shared learning.",
      cards: [
        {
          title: "AI Strategy & Consulting",
          description:
            "Exploring how AI can be applied to real problems — identifying practical use cases and thinking through implementation approaches.",
          imgUrl: "/a1.png",
          imgAlt: "AI Consulting",
        },
        {
          title: "Machine Learning Solutions",
          description:
            "Building ML models for predictive analytics, classification, forecasting, and recommendations using real frameworks and datasets.",
          imgUrl: "/a2.png",
          imgAlt: "Machine Learning",
        },
        {
          title: "Natural Language Processing",
          description:
            "Experimenting with text analysis, sentiment detection, chatbots, and document processing using NLP techniques.",
          imgUrl: "/a3.png",
          imgAlt: "NLP Solutions",
        },
        {
          title: "AI Integration & Deployment",
          description:
            "Learning to integrate AI into real systems with MLOps practices — monitoring, iteration, and continuous improvement.",
          imgUrl: "/a4.png",
          imgAlt: "AI Deployment",
        },
      ],
    ...
    <main>
      ...
      <section className="relative isolate overflow-hidden bg-gradient-to-br from-sky-50 via-white to-blue-100 text-gray-900">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Salesforce, DevOps, AWS, React, AI and more — explored through
            real projects, honest learning, and hands-on collaboration.
          </p>
        </motion.div>
      </section>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join the community, explore our projects, or reach out to collaborate.
          </p>
          <a href="/contact">
            <button className="px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 hover:-translate-y-1 cursor-pointer">
